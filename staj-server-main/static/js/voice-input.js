...
function initializeSpeechRecognition() {
    ...
    // Mikrofon kapandığında tetiklenen olay:
    recognition.onend = function() {
       console.log("Mikrofon kapandı.");
    
       // Eğer kullanıcı 'Durdur' butonuna BASMADIYSA, mikrofonu zorla geri aç!
       if (!isUserStopped) {
           console.log("Tarayıcı mikrofonu zorla kapattı, yeniden başlatılıyor...");
           try {
               recognition.start();
            } catch(e) {
           ...
           // Sadece kullanıcı kendi durdurduysa "Durduruldu" mesajı ver
           console.log("Kayıt başarıyla durduruldu.");
           // UI güncellemelerini burada yapın (Düğmeyi eski haline getirme vb.)
        }
    };
