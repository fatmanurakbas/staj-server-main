// Main JavaScript for HepDecide Risk Assessment System

document.addEventListener('DOMContentLoaded', function() {
    console.log('HepDecide System loaded');
...
function generateResultsText() {
    return 'HepDecide Risk Assessment Results\n' +
           '=====================================\n' +
           'Generated by HepDecide System\n' +
...
function addChatbotMessage(sender, text) {
    ...
    if (sender === 'user') {
        ...
        // Get translation from hidden DOM element
        const assistantLabel = document.getElementById('js-chatbot-assistant')?.textContent || 'HepDecide';
...
function requestServerPDF() {
    ...
    .then(blob => {
        ...
        a.href = url;
        a.download = 'HepDecide_Risk_Assessment.pdf';
